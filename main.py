...
for datatype in datatypes:
    ...
    if datatype == 'roles':
        ...
        for role in roles_results:
            ...
            agents_assigned = [ agent['email'] for agent in temp_agents_results if role['id'] in agent['role_ids'] and agent['active'] == True]
    ...
    if datatype == 'agents':
        ...
        for agent in agents_results:
            ...
            for role_id in agent['role_ids']:
                role_name = [ role['name'] for role in roles_results if role['id'] == role_id]
